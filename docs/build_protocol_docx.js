  ...
  sections: [{
    ...
    children: [
      ...
      rich([
        ...
        { t: ' (10000) и ' }, { t: 'Zonesport', mono: true }, { t: ' (12000) на ' },
      ...
      h1('6. Тач-панель → мастеру (порт 10000)'),
      ...
      bullet('Слушать UDP 10000, отвечать на /zoneN/start, /restart, /reset.'),
      ...
      bullet('Слать /zoneN/sound/<триггер> на 10.10.10.10:12000 для звука.'),
